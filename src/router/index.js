...
const routes = [
  ...
  { path: '/como-funciona', name: 'ComoFunciona', component: () => import('@/pages/landing/ComoFuncionaPage.vue'), meta: { public: true, title: 'Como Funciona' } },
  { path: '/pontuacao',     name: 'Pontuacao',    component: () => import('@/pages/landing/PontuacaoPage.vue'),    meta: { public: true, title: 'Pontuação' } },
  { path: '/disputa',       name: 'Disputa',      component: () => import('@/pages/landing/DisputaPage.vue'),      meta: { public: true, title: 'Disputa' } },
  { path: '/selos',         name: 'SelosInfo',    component: () => import('@/pages/landing/SelosPage.vue'),        meta: { public: true, title: 'Selos' } },
  { path: '/tecnologias',   name: 'Tecnologias',  component: () => import('@/pages/landing/TecnologiasPage.vue'),  meta: { public: true, title: 'Tecnologias' } },
  { path: '/ranking-info',  name: 'RankingInfo',  component: () => import('@/pages/landing/RankingInfoPage.vue'),  meta: { public: true, title: 'Ranking' } },
  ...
  { path: '/games/:slug/bet', name: 'Bet', component: () => import('@/pages/BetPage.vue'),       meta: { title: 'Fazer Palpite' } },
  ...
  { path: '/meus-grupos/:id', name: 'MeusGrupoDetail', component: () => import('@/pages/GrupoDetailPage.vue'),     meta: { title: 'Meu Grupo' } },
