...
const routes = [
  ...
  { path: '/criar-grupo',     name: 'CriarGrupo',  component: () => import('@/pages/CriarGrupoPage.vue'),   meta: { title: 'Criar Grupo' } },
  { path: '/meus-grupos',     name: 'MeusGrupos2', component: () => import('@/pages/CriarGrupoPage.vue'),   meta: { title: 'Meus Grupos' } },
